 ...
 User.create(username: "lukin41280", password: "doubledadjokes")
 User.create(username: "seanswitt", password: "levelexpert")
 User.create(username: "kpatton", password: "newhoodieswag")
