...
post2 = Post.create(title: "Recent breakup - help", question: "My boyfriend just dumped for a set of twins. I am currently weeping in Wal-Mart, what snacks should I buy to drown my sorrows")
